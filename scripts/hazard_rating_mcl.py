...
class HazardRatingMcl:    ###mlparticle（12〜18行目）
    ...
    def draw(self, ax, elems):  
        ...
        C = [p.hazard_weight for p in self.particles]
        elems.append(ax.quiver(xs, ys, vxs, vys, C, angles='xy', scale_units='xy', scale=1.5, alpha=0.5)) #変更
